...
public class ActivityTeste extends AppCompatActivity
    ...
    private void carregarAtivo(int id) throws JSONException, IOException {
        Ativo ativo = APIAtivosCEB.buscarAtivo(id);
        TextView labelIdAtivo = (TextView) findViewById(R.id.labelIDTeste);
        TextView labelItem = (TextView) findViewById(R.id.labelItemTeste);
        labelIdAtivo.setText(ativo.getIdAtivo());
        labelItem.setText(ativo.getItem());
        Log.d("ITEM OBTIDO", ativo.getItem());
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_NovoAtivo) {
            Intent intent = new Intent(ActivityTeste.this, ActivityNovoAtivo.class);
            startActivity(intent);
        } else if (id == R.id.nav_ListaAtivos) {
            Intent intent = new Intent(ActivityTeste.this, ActivityListaAtivos.class);
            startActivity(intent);
